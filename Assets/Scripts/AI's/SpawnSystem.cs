...
public class SpawnSystem : MonoBehaviour
{
    ...
    void NextWave()
    {
        currentWave = waveEditor.ShallowCopy();
...
public class SpawnSystem : MonoBehaviour
{
    ...
    void NextWave()
    {
        currentWave.enemyCount1 = enemyCount1;
        currentWave.enemyCount2 = enemyCount2;
        currentWave.enemyCount3 = enemyCount3;
        currentWave.enemyCount4 = enemyCount4;
        currentWave.enemyCount5 = enemyCount5;
        currentWave.enemyCountTotal = enemyCount1 + enemyCount2 + enemyCount3 + enemyCount4 + enemyCount5;
        currentWave.spawnTime = spawnTime;
        enemiesToSpawn = currentWave.enemyCountTotal;
        enemiesAlive = enemiesToSpawn;
